...
class MyEvent extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => MyEventState();

}

class MyEventState extends State<MyEvent> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // padding: const EdgeInsets.only(right: 12, left: 12, top: 0, bottom: 0,),
      child: Stack(
        children: [
          widget.data['pic'] != ''?Row(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text.rich(
                          TextSpan(
                              children: [
                                const TextSpan( text: '距今',style: TextStyle(fontSize:10.0)),
                              ]
                          )
                      ),
                      Center(
