...
import 'package:easycare/util/todo.dart';
...
class MyTodoList extends StatefulWidget {
  ...
  final ValueChanged<Map> onRun;
  final ValueChanged<Map> onDone;
  final ValueChanged<Map> onReset;
  final VoidCallback pullup;//ValueChanged pullup;//
  final VoidCallback dropdown;//ValueChanged dropdown;//
  @override
  State<StatefulWidget> createState() => MyTodoListState();
}
